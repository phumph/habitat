### Header file for Alexandre, Humphrey et al.
### Ecosphere 2018
...
## this function is not used in the published analyses but can be used to calculate herbivory prevalence at the whole-plant level from simulations
...
# produce additional test statistic: inter-quartile range using R base function IQR()
